  ...
  return (
    <div id ="about"className="whoweare-1">
      ...
      <div className="row-images">
        ...
        <img className="img-whoweare" src="./images/content/nathanyAndBoys.jpeg" alt="Nathany and boys" />
        <img className="img-whoweare" src="./images/content/allFamily.jpeg" alt="All family" />
      </div>
    </div>
  );
}
